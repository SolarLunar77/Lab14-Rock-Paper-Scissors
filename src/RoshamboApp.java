...
public class RoshamboApp {
	...
	Player rockPlayer = new RockPlayer ("Dwayne Johson");
	Player randomPlayer = new RandomPlayer();
	Player humanPlayer = new YourChoice();
...
do {
	...
	do {
		input = Validator.getString(scan, "Would you like to play against Rocky or Rando?");
